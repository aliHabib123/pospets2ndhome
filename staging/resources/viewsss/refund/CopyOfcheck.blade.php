        ...
        <div class="row">
            <div class="col-sm-12 col-md-12">
               <div class="panel panel-bd lobidisable">
					...
					{!! Form::model($invoice, array('route' => array('refund.update', $invoice->id), 'method' => 'PUT', 'files' => false)) !!}
                   ...
                   <?php $canRefund = true; ?>
                    ...
                    @endforeach
                        ...
                        @elseif ($canRefund == false)
                            <p style="color: red;"><b>You cannot refund this invoice due to invalid quantities in stock or does not exist in archive</b></p>
                        @else 
                        {!! Form::open(array('url' => 'refund-invoice')) !!}
                             <input hidden name="invoice_id" value="{{ $invoice->id }}">
                             <button type="submit" class="btn btn-small btn-info">{{trans('refund.refund')}}</button>
                            {!! Form::close() !!}
                        @endif
                   </div>
                </div>
