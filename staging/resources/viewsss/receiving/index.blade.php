                    ...
                    <div class="panel-heading">
                        <div class="panel-title">
                            <input ng-model="searchKeyword" class="form-control"
                                   placeholder="{{trans('receiving.search_item')}}">
                        </div>
                    </div>
                            ...
                            <tr ng-repeat="item in items  | filter: searchKeyword | limitTo:150">
                                ...
                                <td>
                                    <button class="btn-outline btn-success btn-circle" type="button"
                                            ng-click="addReceivingTemp(item, newreceivingtemp)"><span
                        ...
                        <table class="table table-bordered ">
                            ...
                            <tr ng-repeat="newreceivingtemp in receivingtemp">
                                ...
                                <td><input type="text" style="text-align:center" autocomplete="off" name="quantity"
                                           ng-change="updateReceivingTemp(newreceivingtemp)"
                                           ng-model="newreceivingtemp.quantity" size="2"></td>
                                ...
                                <td>
                                    <button class="btn-outline btn btn-danger btn-circle" type="button"
                                            ng-click="removeReceivingTemp(newreceivingtemp.id)"><span
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <label for="employee"
                                           class="col-sm-3 control-label">{{trans('receiving.employee')}}</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group">
                                    <label for="supplier_id"
                                           class="col-sm-3 control-label">{{trans('receiving.supplier')}}</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group">
                                    <label for="payment_type"
                                           class="col-sm-3 control-label">{{trans('receiving.payment_type')}}</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group" style="visibility: hidden">
                                    <label for="total"
                                           class="col-sm-3 control-label">{{trans('receiving.amount_tendered')}}</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group">
                                    <label for="supplier_id"
                                           class="col-sm-3 control-label">{{trans('receiving.grand_total')}}</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        <button type="submit"
                                                class="btn btn-success btn-block">{{trans('receiving.submit')}}</button>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="employee"
                                           class="col-sm-3 control-label">{{trans('receiving.comments')}}</label>
                                    <div class="col-sm-9">
...
@section('script')
    ...
    {!! Html::script('js/receiving.js', array('type' => 'text/javascript')) !!}
