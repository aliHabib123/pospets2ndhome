        ...
        <div class="row" ng-controller="SearchItemCtrl">
                    ...
                    <div class="panel-body">
                        <table class="table table-bordered">
                            ...
                            <tr ng-repeat="newsaletemp in saletemp">
                                ...
                                <td>{{$currency}} @{{newsaletemp.item.selling_price}}</td>
                                ...
                                <td>{{$currency}} @{{newsaletemp.item.selling_price * newsaletemp.quantity }}</td>
                                <td>
            ...
            <div class="col-md-4">
                <div class="panel panel-bd paper-cut">
                    ...
                    <div class="panel-body">
                        <div class="row ">
                            {!! Form::open(array('url' => 'sales','name' => 'sales', 'class' => 'form-horizontal')) !!}
                            <div class="col-md-12">
