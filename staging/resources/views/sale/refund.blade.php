                    ...
                    <div class="row ">
                        <div class="col-md-12">
                            <form class="form form-horizontal">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        <button class="btn btn-success btn-block" ng-disabled="SaleInvoice.discount < 0 || SaleInvoice.discount > sum(SaleItems)" ng-click="updateInvoice(SaleInvoice, SaleItems)">Update Sale</button>
                                    </div>
                                </div>
...
{!! Html::script('js/sale-refund.js?v=1.0.2', array('type' => 'text/javascript')) !!}
@endsection