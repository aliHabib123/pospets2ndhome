            ...
            <div class="row">
                <div class="col-md-8 col-sm-10 col-xs-10">
                    ...
                    <ul class="list-inline">
                        ...
                        <li>
                            <div class="i-check">
                                <input ng-click="showWholesales = !showWholesales" tabindex="1" type="checkbox" id="check_wholesales"
                                       checked>
                                <label for="check_wholesales">{{trans('report.wholesales')}}</label>
                            </div>
                        </li>
                        <li>
                            <div class="i-check">
                ...
                <div class="col-sm-12 col-md-12">
                    <div class="panel panel-bd lobidisable">
                        ...
                        <div class="panel-body">
                            ...
                            <table ng-show="showWholesales" class="table table-striped table-bordered table-hover">
                                <!-- sales -->
                                <thead>
                                <tr>
                                    <td>
                                        <div class="panel-title amount">{{trans('report.wholesales')}}</div>
                                    </td>
                                    <td width="100">{{trans('report.qty')}}</td>
                                    <td width="150">{{trans('report.total')}}</td>
                                    <td width="150">{{trans('report.discount')}}</td>
                                ...
                                <tbody>
                                <tr ng-repeat="item in closeout.wholesales" ng-show="showWholesales">
                                    <td ng-if="!$last">@{{ item.name  }}  </td>
                                    <td ng-if="$last"><b> {{trans('report.sum')}} </b></td>
                                    <td>@{{ item.sum }}</td>
                                    <td><span class="amount">@{{ item.selling | number }}  {{$currency}}</span></td>
...
@section('script')
    ...
    {!! Html::script('js/closeout2.js', array('type' => 'text/javascript')) !!}
