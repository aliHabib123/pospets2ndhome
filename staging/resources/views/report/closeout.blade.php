                        ...
                        <div class="panel-body">
                            <table ng-show="showSales" class="table table-striped table-bordered table-hover">
                                ...
                                <tr ng-repeat="item in closeout.sales" ng-show="showSales">
                                    ...
                                    <td>@{{ item.sum }}</td>
                                    <td><span class="amount">@{{ item.selling | number }}  LBP</span></td>
                                    <td><span class="amount">@{{ item.discount | roundup | number }}  LBP</span></td>
                                    <td  style="font-weight: bold;"><span class="amount">@{{ (item.selling - item.discount ) | rounddown | number }}  LBP</span></td>
                                    <?php if (Auth::user()->roles[0]->name == "Admin" || Auth::user()->roles[0]->name == "Manager"){?>
                                    <td><span class="amount">@{{ item.cost | number }}  LBP</span></td>
                                    <td><span class="amount">@{{ item.profit - item.discount | number }}  LBP</span></td>
                                    <?php }?>
                                </tr>
                                </tbody>
                            </table>
